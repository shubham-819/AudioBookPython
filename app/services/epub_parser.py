...
def parse_epub_content(epub_content: bytes) -> Tuple[Novel, List[Dict]]:
    """
    Parse an EPUB file and extract its content.
    Returns a tuple of (Novel object, List of chapter dictionaries for Firestore)
    """
...
def extract_chapter_content(soup: BeautifulSoup) -> List[str]:
    """
    Extract and clean chapter content, returning a list of paragraphs
    """
